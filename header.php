...
<head>
	...
	<!-- Font Awesome -->
	<script src="https://kit.fontawesome.com/e7e6cbb32f.js" crossorigin="anonymous"></script>
	<?php wp_head(); ?>
</head>
...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'omakase' ); ?></a>
